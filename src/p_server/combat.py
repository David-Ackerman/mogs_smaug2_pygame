class Combat:
    ...
    def combat(self, username: str, attack, defense=None):
    ...
    def summonCard(self, username: str, card):
    ...
    def destroyCard(self, playerDestroyed, cardDestroyed, cardPos='front'):
